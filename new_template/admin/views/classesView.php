            ...
            <header class="z-40" :class="{'dark' : $store.app.semidark && $store.app.menu === 'horizontal'}">
                <div class="shadow-sm">
                    <div class="relative flex w-full items-center"
                        style="background-color: #2b2b2b; padding: 5px 5px; dark:bg-[#0e1726]">
                        <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="assets/images/university.png"
                                    alt="image" />
                                <span
                                    class="hidden align-middle text-2xl font-semibold transition-all duration-300 ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light md:inline">CONSEJERIA
                                    UPRA</span>
                            </a>
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                            ...
                            <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                ...
                                <?php foreach ($terms as $term) { ?>
                                    <li><a href="?offer&otherterm=<?php echo $term['term'] ?>"
                                            @click="toggle"><?php echo $term['term'] ?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                            <div class="flex gap-3">
                                <div x-data="modal">
                                    <?php if ($privileges == 1) { ?>
                                        <button type="button" class="btn btn-primary !mt-6" @click="toggle">Crear term
                                            nuevo</button>
                                    <?php } ?>
                        ...
                        <ul class="w-24 m-auto text-center font-semibold">
                            ...
                            <li>
                                <a href="?classes"
                                    ...
                                    :class="{'text-secondary before:!h-[80%]' : tab === 'concentracion'}"
                                    @click="tab='concentracion'">Cursos de CCOM</a>
                            <li>
                                <a href="?ccomelectives"
                                    class="p-3.5 py-4 -mb-[1px] block ltr:border-r rtl:border-l border-white-light dark:border-[#191e3a] relative before:transition-all before:duration-700 hover:text-secondary before:absolute before:w-[1px] before:bottom-0 before:top-0 ltr:before:-right-[1px] rtl:before:-left-[1px] before:m-auto before:h-0 before:bg-secondary hover:before:h-[80%]"
                                    :class="{'text-secondary before:!h-[80%]' : tab === 'electivas'}">Electivas CCOM</a>
                            </li>
                            <li>
                                <a href="?generalclasses"
                                    class="p-3.5 py-4 -mb-[1px] block ltr:border-r rtl:border-l border-white-light dark:border-[#191e3a] relative before:transition-all before:duration-700 hover:text-secondary before:absolute before:w-[1px] before:bottom-0 before:top-0 ltr:before:-right-[1px] rtl:before:-left-[1px] before:m-auto before:h-0 before:bg-secondary hover:before:h-[80%]"
                                    :class="{'text-secondary before:!h-[80%]' : tab === 'generales'}">Cursos
                                    generales</a>
                            </li>
                            <li>
                                <a href="?dummyclasses"
                                    class="p-3.5 py-4 -mb-[1px] block ltr:border-r rtl:border-l border-white-light dark:border-[#191e3a] relative before:transition-all before:duration-700 hover:text-secondary before:absolute before:w-[1px] before:bottom-0 before:top-0 ltr:before:-right-[1px] rtl:before:-left-[1px] before:m-auto before:h-0 before:bg-secondary hover:before:h-[80%]"
                                    :class="{'text-secondary before:!h-[80%]' : tab === 'dummy'}">Cursos dummy</a>
                            </li>
                            <li>
                                <a href="?offer"
                                    class="p-3.5 py-4 -mb-[1px] block ltr:border-r rtl:border-l border-white-light dark:border-[#191e3a] relative before:transition-all before:duration-700 hover:text-secondary before:absolute before:w-[1px] before:bottom-0 before:top-0 ltr:before:-right-[1px] rtl:before:-left-[1px] before:m-auto before:h-0 before:bg-secondary hover:before:h-[80%]"
                                    :class="{'text-secondary before:!h-[80%]' : tab === 'oferta'}">Cursos en oferta</a>
                            </li>
                        </ul>
                    </div>
